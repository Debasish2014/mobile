        ...
        <div class="header">
            <div class="container">
                <div class="row">
                    <div class="col-md-9">
                        <div class="logo">
                            <span class="company-name  hidden-xs">Company Name</span><a href="index.php"><img src="img/logo.png" alt=""></a>
                        </div>
                        <div class="home_menu">
                            <nav>
                                <ul>
                                    <li class="active1"><a href="index.php">Home</a>
                                    </li>
                    ...
                    <div class="col-md-3 hidden-sm">
                        <div class="header-wrapper clearfix">
                            <div class="right-link header-link-bottom clearfix">
                                    ...
                                    <ul>
                                        ...
                                        <li class="arrow-plus">
                                            ...
                                            <div class="cat-left-drop-menu">
                                                ...
                                                <div class="cat-left-drop-menu-left">
                                                    <a class="menu-item-heading" href="#">Mobiles </a>
                                                </div>
                                                <div class="cat-left-drop-menu-left">
                                                    <a class="menu-item-heading" href="#">Chargers </a>
                                                </div>
                                            </div>
                                        </li>
                                        <li class="arrow-plus">
                            ...
                            <div class="top-cart-wrapper">
                                <div class="top-cart-contain">
                                    <div class="block-cart">
                                        <div class="top-cart-title hidden-xs hidden-sm">
                                            <div class = "my-cart ">Shopping cart</div>
                                            <a href="#">
                                                <p>(2) item:<span>&#8377; 100.00</span></p>
                                            </a>
                                        </div>
                                        <div class="home">
                                            <ul>
