	...
	<div class="row bottom40">
	       ...
	       <div class="col-md-3 ">
            ...
            <div class="list-group ">
                ...
                <a href="edit-account.php" class="list-group-item list-group-item-action">Edit Account</a>
                <a href="change-password.php" class="list-group-item list-group-item-action active">Password</a>
		                    ...
		                    <form>
                              <div class=" ">
                               ...
                               <div class=" ">
                                ...
                                <div class="col-8">
                                  <input id="newpass" name="newpass" placeholder="Confirm Password" class="form-control here" type="text">
                                </div>
                              </div> 
                              <div class=" ">
